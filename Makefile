...
Battleship: main.o Board.o Ship.o Player.o gameManager.o Animations.o
		g++ -std=c++11 -g -Wall main.o Board.o Ship.o Player.o gameManager.o Animations.o -o Battleship
